...
ADGlobalDisplacementAux::validParams()
{
  ...
  params.addRequiredParam<unsigned int>("component", "Displacement component produced by this AuxKernel");
...
ADGlobalDisplacementAux::ADGlobalDisplacementAux(const InputParameters & parameters)
  : AuxKernel(parameters),
    ...
    _periodicity_uo(
        getUserObject<GlobalStrainPeriodicDirUserObject>("global_strain_uo")),
